+++
title = "NFTs Are Absolute Bullshit"
...
Let's start with the basics: Non-Fungible Token. But what does [fungible](https://en.wiktionary.org/wiki/fungible) mean? Simply put, not replaceable. Unlike any cryptocurrency, where one BTC is equal and identical in value to another, an NFT is unique and is assigned to a specific public address that "*certifies ownership*".
...
NFTs are often touted as a way to protect intellectual property and copyright. The pitch goes: I create an NFT with a link to a work of my creation, sell it on [OpenSea](https://opensea.io/), and by doing so I **transfer** ownership of the work. There are two major problems with this approach:

1. Verification that the seller actually owns the content.
2. The buyer's ability to claim ownership rights.
...
As further proof of this tool's uselessness, [on DefiLlama](https://defillama.com/nfts) we can clearly see how, compared to the 2021 boom, NFT transaction volumes have shrunk at a frightening rate — as happens in the best bubbles of our time.
